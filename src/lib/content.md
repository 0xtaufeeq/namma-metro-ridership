...
<h1 class="text-5xl md:text-7xl font-bold mb-12 leading-tight tracking-tight text-foreground">How Bangalore Uses the Metro</h1>

<div class="prose prose-lg max-w-none mb-12">
	<p class="text-xl md:text-2xl leading-relaxed text-muted-foreground font-light mb-6">
...
<hr class="w-full !my-16 !border-b !border-neutral-200 p-0">
...
<div class="mt-16 pt-8 border-t border-neutral-300">
	<h2 class="text-2xl md:text-3xl font-bold mb-6 text-foreground tracking-tight">Methodology</h2>
	<div class="prose prose-sm max-w-none text-muted-foreground leading-relaxed space-y-4">
		<p>
			The <a href="https://github.com/Vonter/bmrcl-ridership-hourly" class="text-primary underline hover:no-underline">source data</a> was acquired through a Right to Information (RTI) request to <a href="https://english.bmrc.co.in/" class="text-primary underline hover:no-underline">BMRCL</a>. It covers the period from August 1st to August 18th, 2025. While this includes a week after the Yellow Line opened, patterns observed from a single week cannot be used to conclusively establish the long-term impact of the line on ridership. Longer periods of data are needed to draw definitive conclusions. The week from 11th August to 18th August also coincides with other events such as Independence Day and the Lalbagh Flower Show, which may have affected ridership patterns in different ways.
		</p>
	</div>
</div>
